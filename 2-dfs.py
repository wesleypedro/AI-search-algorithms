...
# -*- coding: utf-8 -*-
# -----------------------------------------------------------------------------
""" DFS algorithm with a representation using pygame """
# -----------------------------------------------------------------------------
...
window_title = "Depth-First Search - DFS - Busca em Profundidade"
            ...
            if len(stack) > 0:
                ...
                if flag == False:
                    ...
                    for cn in current_cell.neighbors:
                        if cn.wall or cn in visited:
                            continue

                        if cn not in visited and not cn.visited:
                            cn.visited = True
