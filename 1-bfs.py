...
# -*- coding: utf-8 -*-
# -----------------------------------------------------------------------------
""" BFS algorithm with a representation using pygame """
# -----------------------------------------------------------------------------
...
window_title = "Breadth-First Search - BFS - Busca em Largura"
            ...
            if len(queue) > 0:
                ...
                if flag == False:
                    for cn in current_cell.neighbors:
                        if not cn.visited and not cn.wall:
                            cn.visited = True
